...
def update_transaction_records(request, token):
    ...
    account_sid = 'AC1279455ea2a384da8534df3da7575fa7'
    auth_token = '9abd9d54605f5096c94fb1d42e9d73ae'
    client = Client(account_sid, auth_token)

    message = client.messages.create(
        from_='whatsapp:+14155238886',
        body='Thank you! Your purchase was successful!',
        to='whatsapp:+919712167265'
    )
